...
def turtle4():
    """
    Make s turtle  for step 4
    """
    juan = rg.SimpleTurtle()
    juan.speed = 30
    juan.pen = rg.Pen('gray',10)
    juan.backward(40)
    juan.draw_regular_polygon(5,100)


def turtle5():
    kobe = rg.SimpleTurtle()
    lebron = rg.SimpleTurtle()
    kobe.speed = 20
    lebron.speed = 20
    kobe.pen = rg.Pen('purple',10)
    lebron.pen = rg.Pen('purple',10)
    kobe.right(90)
    lebron.left(90)
    kobe.forward(100)
    lebron.forward(100)
    kobe.draw_circle(25)
    lebron.draw_circle(25)
